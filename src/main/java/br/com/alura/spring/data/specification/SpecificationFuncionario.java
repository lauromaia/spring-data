...
public class SpecificationFuncionario {
	...
	public static Specification<Funcionario> dataContrato(LocalDate data) {
		return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.greaterThan(root.get("dataContrato"), data);
	}
